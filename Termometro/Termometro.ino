...
void loop () {
  ...
  if (celsius != cel){
    celsius = cel;
    Serial.print("celsius: "); Serial.print(celsius); Serial.print(" data: "); Serial.print(data); Serial.print(" kelvin: "); Serial.print(kelvin); Serial.print(" fahrenheit: "); Serial.print(fahrenheit); Serial.println();
    }
  delay(500);
}
